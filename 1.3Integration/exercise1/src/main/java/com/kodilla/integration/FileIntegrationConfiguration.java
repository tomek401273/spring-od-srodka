...
public class FileIntegrationConfiguration {
    ...
    FileReadingMessageSource fileAdapter(){
        ...
        fileReadingMessageSource.setDirectory(new File("1.3Integration/exercise1/src/main/resources/data/input"));
    ...
    @Bean
    FileWritingMessageHandler outputFileHandler(){
        File direcotry =  new File("1.3Integration/exercise1/src/main/resources/data/output/");
